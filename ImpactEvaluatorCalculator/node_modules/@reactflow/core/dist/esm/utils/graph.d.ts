...
import { Node, Edge, Connection, EdgeMarkerType, Transform, XYPosition, Rect, NodeInternals, NodeOrigin, UpdateEdgeOptions, Viewport, ReconnectEdgeOptions } from '@reactflow/packages/core/src/types';
...
export declare const reconnectEdge: (oldEdge: Edge, newConnection: Connection, edges: Edge[], options?: ReconnectEdgeOptions) => Edge[];
/**
 *
