...
![Correlation Matrix - Pre-Treatment](../notebooks/analysis_ntbk_media/uniswap_correlation_analysis.png)
...
![Rolling Correlations: Counterfactual Time Series vs Uniswap Transactions](../notebooks/analysis_ntbk_media/uniswap_rolling_60_days_corralation.png)
...
![Uniswap Log-Transformed Causal Impact Analysis](../notebooks/analysis_ntbk_media/uniswap_log_transformed_causal_impact_fit.png)
...
![Box-Cox Transformation Distribution of Variables](../notebooks/analysis_ntbk_media/uniswap_boxcox_transformation_distribution_of_variables.png)
...
![Uniswap Box-Cox Transformed Causal Impact Analysis](../notebooks/analysis_ntbk_media/uniswap_boxcox_transformed_fit.png)
...
![Residuals Over Time](../notebooks/analysis_ntbk_media/uniswap_residuals_overtime.png)

![ACF of Residuals](../notebooks/analysis_ntbk_media/uniswap_boxcox_acf_residuals.png)
...
![Correlation Matrix - Pre-Treatment for Aerodrome](../notebooks/analysis_ntbk_media/erodrome_correlation_analysis.png)
...
![Aerodrome Box-Cox Transformed Causal Impact Analysis](../notebooks/analysis_ntbk_media/aerodrome_boxcox_transformed_bestift.png)
...
![Residuals Over Time for Aerodrome](../notebooks/analysis_ntbk_media/aerodrome_bestfit_residuals.png)

![ACF of Residuals for Aerodrome](../notebooks/analysis_ntbk_media/aerodrome_acf_residuals_analysis.png)
...
![Correlation Matrix - Pre-Treatment for Velodrome](../notebooks/analysis_ntbk_media/velodrome_correlation_analysis.png)
...
![Velodrome Causal Impact Analysis](../notebooks/analysis_ntbk_media/Velodrome_bestfit.png)
...
![Residuals Over Time for Velodrome](../notebooks/analysis_ntbk_media/velodrome_bestfit_residuals.png)

![ACF of Residuals for Velodrome](../notebooks/analysis_ntbk_media/velodrome_bestfit_acf_residuals.png)
